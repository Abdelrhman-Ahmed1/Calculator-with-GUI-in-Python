...
def set_dot():
    text_edit.insert(END,".")
def del_():
    text_edit.delete(text_edit.index("end") - 1)
...
butdel = Button(frame2, text="⌫", font=("Arial", 20), width=12, bd=0, foreground="white", background="#2B2B2B", command=del_)
butdel.grid(row=5, column=0, sticky=tk.W+tk.E)
